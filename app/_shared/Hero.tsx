  ...
  return (
    <div className="p-10 md:px-24 lg:px-48 xl:px-60 mt-10">
      ...
      <h2 className="text-6xl font-bold text-center">
        Design High Quality{" "}
        <span className="text-indigo-500">Website and Mobile App</span> Designs{" "}
      </h2>
      <p className="text-center text-gray-600 text-lg mt-3">
        Imagine your idea and turn it into reality with our expert design
        services.
      </p>
      ...
      <div className="flex gap-3 mt-5">
        {suggestions.map((suggestion, index) => (
          <div
            key={index}
            className="flex flex-col items-center space-x-2 p-2 border-b border-gray-200 bg-white z-10 rounded-2xl cursor-pointer hover:shadow-md transition-shadow duration-300 ease-in-out"
